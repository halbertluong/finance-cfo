    ...
    <main className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Sign in to access your finances</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white hover:bg-gray-50 text-gray-800 font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed transition-all"
        >
          {loading ? (
